...
public class CategoryController {
    ...
    @Operation(summary = "Endpoint to retrieve a category.",
    		description = "It provides the necessary mechanism to be able to recover a category from its id.")
    @ApiResponses(value = { 
			@ApiResponse(responseCode = "200", description = "Ok"),
			@ApiResponse(responseCode = "404", description = "Not Found", 
					content = @Content(schema = @Schema())),
    ...
    public ResponseEntity<CategoryDetailDto>getCategory(
    		@Parameter(description = "Id of the category to be obtained.", example = "528f22c3-1f9c-493f-8334-c70b83b5b885") 
